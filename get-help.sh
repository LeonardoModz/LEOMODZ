...
display_banner() {
    clear
    figlet -f slant "AJUDA" | lolcat
    echo "BEM-VINDO AO CENTRAL AJUDA!" | lolcat
    echo "ESCOLHA UMA OPÇÃO ABAIXO:" | lolcat
}
...
case $choice in
    ...
    6)
        ...
        ;;
    0)
        echo "SAINDO DO SCRIPT CENTRAL AJUSA. ADEUS!" | lolcat
        exit 0
        ;;
    *)
        echo "ESCOLHA INVÁLIDA. POR FAVOR, DIGITE UMA NÚMERO ENTRE 0 OU 6." | lolcat
        ;;
esac
